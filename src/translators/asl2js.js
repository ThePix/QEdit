...
const jsReplacements = [
  ...
  {asl:/list add \(([0-9a-zA-Z_."]+), ([0-9a-zA-Z_."]+)\)/g, js:'$.push($)'},
  ...
  {asl:/ListExclude \(([0-9a-zA-Z_."]+, [0-9a-zA-Z_."]+)/g, js:'arraySubtract($1, $2)'},
  ...
  {asl:/IsRegexMatch \(([0-9a-zA-Z_."]+), ([0-9a-zA-Z_."]+)\)/g, js:'$.match(regex)'},
