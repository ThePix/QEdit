...
export class MainPane extends React.Component {
  ...
  render() {
    ...
    if (this.props.object) {
      ...
      //let colour = this.props.object.jsColour || 'blue'
      //if (this.props.options.darkMode && ALT_COLOURS[colour]) colour = ALT_COLOURS[colour]
      //const pStyle = {color:colour, padding:3};
  ...
  if (props.input.type === "select") {
    return (
      <tr className="form-group">
        ...
        <td>
          <SelectComp name={props.input.name} options={props.input.options} tooltip={props.input.tooltip}  default={props.input.default}handleChange={props.handleChange} value={value}/>
        </td>
      </tr>
    );
  }
    ...
    return (
      <tr className="form-group">
        <td width="30%"><span className="fieldName">{props.input.display}</span></td>
        <td>
          <SelectComp name={props.input.name} options={Object.keys(lang.pronouns)} tooltip={props.input.tooltip}  default={props.input.default}handleChange={props.handleChange} value={value}/>
        </td>
      </tr>
    );
  }
    ...
    return (
      <tr className="form-group">
        <td width="30%"><span className="fieldName">{props.input.display}</span></td>
        <td>
          <SelectComp name={props.input.name} options={options} tooltip={props.input.tooltip}  default={props.input.default}handleChange={props.handleChange} value={value}/>
        </td>
      </tr>
    );
  }
    ...
    return (  
      <tr className="form-group">
        <td width="30%"><span className="fieldName">{props.input.display}</span></td>
        <td><TickComp name={props.input.name} options={Object.keys(lang.pronouns)} tooltip={props.input.tooltip}  default={props.input.default}handleChange={props.handleCBChange} value={value}/></td>
      </tr>
    )
  }
    ...
    return (  
      <tr className="form-group">
        ...
        <textarea
          ...
          datadefault={props.input.default}
          value={value}
